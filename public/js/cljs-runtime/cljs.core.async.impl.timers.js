...
while(true){
if((i <= self__.level)){
var links_12809 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12809[i]));
} else {
x__$2.forward.push((((i < links_12809.length))?(links_12809[i]):null));
}

if((i < links_12809.length)){
(links_12809[i] = x__$2);
} else {
links_12809.push(x__$2);
}
...
var i_12817 = (0);
while(true){
if((i_12817 <= self__.level)){
var links_12821 = (update[i_12817]).forward;
if((x__$1 === (((i_12817 < links_12821.length))?(links_12821[i_12817]):null))){
(links_12821[i_12817] = (x__$1.forward[i_12817]));

var G__12822 = (i_12817 + (1));
i_12817 = G__12822;
continue;
} else {
var G__12823 = (i_12817 + (1));
i_12817 = G__12823;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__12835 = nx;
var G__12836 = (level__$1 - (1));
x = G__12835;
level__$1 = G__12836;
continue;
} else {
var G__12837 = x;
var G__12838 = (level__$1 - (1));
x = G__12837;
level__$1 = G__12838;
continue;
}
