...
return G__8084__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__8085 = c;
var G__8085__$1 = (((G__8085 == null))?null:G__8085.prototype);
if((G__8085__$1 == null)){
return null;
} else {
return G__8085__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__8094 = c;
var G__8094__$1 = (((G__8094 == null))?null:G__8094.constructor);
if((G__8094__$1 == null)){
return null;
} else {
return G__8094__$1.displayName;
}
})();
...
var G__8095 = c;
var G__8095__$1 = (((G__8095 == null))?null:G__8095.constructor);
if((G__8095__$1 == null)){
return null;
} else {
return G__8095__$1.name;
}
}
});
...
var _STAR_current_component_STAR__temp_val__8108 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__8108);
...
var G__8113 = key;
var G__8113__$1 = (((G__8113 instanceof cljs.core.Keyword))?G__8113.fqn:null);
switch (G__8113__$1) {
...
var c = this;
var G__8124_8262 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__8124_8262 == null)){
} else {
reagent.ratom.dispose_BANG_(G__8124_8262);
}
...
var renders_8272 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_8273 = cljs.core.first(cljs.core.vals(renders_8272));
...
if((cljs.core.count(renders_8272) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_8272))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_8273)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_8273], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__8181 = o;
reagent.impl.component.goog$module$goog$object.set(G__8181,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__8216 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__8217 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__8217);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__8216);
}});
...
var vec__8218 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8218,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8218,(1),null);
...
var G__8225 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__8225 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__8225);
}
});
}),[]);
