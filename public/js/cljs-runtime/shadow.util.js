...
while(true){
if((i__5727__auto___10293 < len__5726__auto___10290)){
args_arr__5751__auto__.push((arguments[i__5727__auto___10293]));

var G__10295 = (i__5727__auto___10293 + (1));
i__5727__auto___10293 = G__10295;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq10186){
var G__10189 = cljs.core.first(seq10186);
var seq10186__$1 = cljs.core.next(seq10186);
var G__10190 = cljs.core.first(seq10186__$1);
var seq10186__$2 = cljs.core.next(seq10186__$1);
var G__10191 = cljs.core.first(seq10186__$2);
var seq10186__$3 = cljs.core.next(seq10186__$2);
var G__10192 = cljs.core.first(seq10186__$3);
var seq10186__$4 = cljs.core.next(seq10186__$3);
var G__10194 = cljs.core.first(seq10186__$4);
var seq10186__$5 = cljs.core.next(seq10186__$4);
var G__10195 = cljs.core.first(seq10186__$5);
var seq10186__$6 = cljs.core.next(seq10186__$5);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10189,G__10190,G__10191,G__10192,G__10194,G__10195,seq10186__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__10223){
var vec__10224 = p__10223;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10224,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10224,(1),null);
