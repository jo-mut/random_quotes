...
var G__8281 = o;
reagent.impl.template.goog$module$goog$object.set(G__8281,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__8352__i < G__8352__a.length) {G__8352__a[G__8352__i] = arguments[G__8352__i + 0]; ++G__8352__i;}
  args = new cljs.core.IndexedSeq(G__8352__a,0,null);
} 
...
var G__8282 = o;
reagent.impl.template.goog$module$goog$object.set(G__8282,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__8360__i < G__8360__a.length) {G__8360__a[G__8360__i] = arguments[G__8360__i + 0]; ++G__8360__i;}
  args = new cljs.core.IndexedSeq(G__8360__a,0,null);
} 
...
var G__8283 = props;
var G__8283__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8283,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8283);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8283__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8284 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8284,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8284;
}
})(),id_class);
...
var G__8285 = (cljs.core.count(argv) - first_child);
switch (G__8285) {
case (0):
...
var vec__8286 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8286,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8286,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8286,(2),null);
...
var temp__5808__auto___8381 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___8381 == null)){
} else {
var key_8382 = temp__5808__auto___8381;
(jsprops.key = key_8382);
}
...
var temp__5808__auto___8384 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___8384 == null)){
} else {
var key_8385 = temp__5808__auto___8384;
(jsprops.key = key_8385);
}
...
var temp__5808__auto___8390 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___8390 == null)){
} else {
var key_8391 = temp__5808__auto___8390;
(jsprops.key = key_8391);
}
...
var temp__5808__auto___8409 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___8409 == null)){
} else {
var key_8410 = temp__5808__auto___8409;
(jsprops.key = key_8410);
}
...
var temp__5808__auto___8414 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___8414 == null)){
} else {
var key_8418 = temp__5808__auto___8414;
(jsprops.key = key_8418);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8306_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__8306_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__8307 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8307,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8307,(1),null);
...
break;
default:
var G__8430 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__8431 = compiler;
v = G__8430;
compiler = G__8431;
continue;
...
var G__8323 = tag;
var G__8323__$1 = (((G__8323 instanceof cljs.core.Keyword))?G__8323.fqn:null);
switch (G__8323__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template8331 = (function (opts,id,fn_to_element,parse_fn,meta8332){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta8332 = meta8332;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template8331.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_8333,meta8332__$1){
var self__ = this;
var _8333__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template8331(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta8332__$1));
}));

(reagent.impl.template.t_reagent$impl$template8331.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_8333){
var self__ = this;
var _8333__$1 = this;
return self__.meta8332;
}));

(reagent.impl.template.t_reagent$impl$template8331.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template8331.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template8331.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template8331.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template8331.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template8331.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta8332","meta8332",1457512972,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template8331.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template8331.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template8331");

(reagent.impl.template.t_reagent$impl$template8331.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template8331");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template8331.
 */
reagent.impl.template.__GT_t_reagent$impl$template8331 = (function reagent$impl$template$__GT_t_reagent$impl$template8331(opts,id,fn_to_element,parse_fn,meta8332){
return (new reagent.impl.template.t_reagent$impl$template8331(opts,id,fn_to_element,parse_fn,meta8332));
});
...
return (new reagent.impl.template.t_reagent$impl$template8331(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
